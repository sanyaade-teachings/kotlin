...
open class ExtraClassInfoGenerator() {
    ...
    /**
     * //TODO(cleanup) check package prefix accuracy
     * @param inlinedClassPrefix - includes class internal name and method name. example value is "bar.OuterClass$InnerClass$calculate"
     */
