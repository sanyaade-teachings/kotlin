...
fun box(): String {
    ...
    require(nullableReturnTypeMethod.toGenericString() == "public static final ${wrapperClass.name}<java.lang.Integer> ${exampleClass.name}.${nullableReturnTypeMethod.name}(${wrapperClass.name}<java.lang.String>)") {
    ...
    require(nullablePropertyGetter.toGenericString() == "public final ${wrapperClass.name}<java.lang.Integer> ${exampleClass.name}.${nullablePropertyGetter.name}()") {
    ...
    require(nullablePropertyField.toGenericString() == "private static final ${wrapperClass.name}<java.lang.Integer> ${exampleClass.name}.${nullablePropertyField.name}") {
