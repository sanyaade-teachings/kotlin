...
public func interfaceWithFactory() -> any main.InterfaceWithFactory {
    return KotlinRuntime.KotlinBase(__asExistentialWrappingExternalRCRef: __root___InterfaceWithFactory()) as! any main.InterfaceWithFactory
}
public func interfaceWithFactory(
    arg: KotlinRuntime.KotlinBase
) -> any main.InterfaceWithFactory {
    return KotlinRuntime.KotlinBase(__asExistentialWrappingExternalRCRef: __root___InterfaceWithFactory__TypesOfArguments__KotlinRuntime_KotlinBase__(arg.__externalRCRef())) as! any main.InterfaceWithFactory
}
