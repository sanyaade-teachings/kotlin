...
constructor(
    project: Project,
    private val targetsContainer: KotlinTargetsContainer = project.objects.newInstance<KotlinTargetsContainer>(),
    internal val presetFunctions: KotlinTargetContainerWithPresetFunctions = project.objects
    ...
    override fun js(
        ...
        return (presetFunctions as DefaultKotlinTargetContainerWithPresetFunctions).configureOrCreate(
            name,
            @Suppress("DEPRECATION_ERROR")
    ...
    override fun wasmJs(
        ...
        (presetFunctions as DefaultKotlinTargetContainerWithPresetFunctions).configureOrCreate(
            name,
            @Suppress("DEPRECATION_ERROR")
...
internal val KotlinMultiplatformExtension.defaultPresetFunctions
    get() = presetFunctions as DefaultKotlinTargetContainerWithPresetFunctions
